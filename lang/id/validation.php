...
return [
    ...
    | ukuran. Anda bebas untuk menyesuaikan pesan-pesan ini sesuai kebutuhan.
    |
    */
    ...
    'present_with_all' => 'Kolom :attribute harus ada ketika :values semua ada.',
    ...
    | menggunakan konvensi "attribute.rule" untuk menamai baris. Ini memungkinkan
    | Anda untuk dengan cepat menentukan pesan bahasa khusus untuk aturan atribut tertentu.
    |
    */
    ...
    | alih-alih "email". Ini hanya untuk membuat pesan lebih jelas.
    |
    */

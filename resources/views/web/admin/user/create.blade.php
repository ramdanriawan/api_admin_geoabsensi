    ...
    <div class="row">
        <div class="col-xs-6 col-md-6 col-lg-6">
            <div class="panel panel-default">
                ...
                <!-- Tab panes -->
                    <form method="post" action="{{ url(route('web.admin.user.store')) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="password" name="password"
                                   value="{{ old('password') == '' ? 'user1234' : old('password') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="password" name="password_confirmation"
                                   value="{{ old('password_confirmation') == '' ? 'user1234' : old('password_confirmation') }}" required>

        ...
        <div class="col-xs-6 col-md-6 col-lg-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <!-- Tab panes -->
                    <form method="POST" action="{{ route('web.admin.recape.update', $recape->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="user_id"
                                   value="{{ old('user_id', $recape->user_id) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="period_start"
                                   value="{{ old('period_start', $recape->period_start) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="period_end"
                                   value="{{ old('period_end', $recape->period_end) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" name="basic_salary"
                                   value="{{ old('basic_salary', $recape->basic_salary) }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" name="meal_allowance"
                                   value="{{ old('meal_allowance', $recape->meal_allowance) }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" name="transport_allowance"
                                   value="{{ old('transport_allowance', $recape->transport_allowance) }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" name="overtime_pay"
                                   value="{{ old('overtime_pay', $recape->overtime_pay) }}">
                        </div>

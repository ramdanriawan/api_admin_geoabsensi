            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="{{ url(route('web.admin.visitType.create')) }}" class="btn btn-xs btn-primary"
                        ...
                        <div class="tab-pane fade padding in active" id="Active">
                            <table class="table " id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th width="auto">Employee VisitType Count</th>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            let datatable1 = $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ url(route('api.v1.web.admin.visitType.dataTable')) }}',
                },
                pageLength: 10,

        ...
        <div class="col-xs-6 col-md-6 col-lg-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <!-- Tab panes -->
                    <form method="post"
                          action="{{ url(route('web.admin.employeeOffDay.update', ['employeeOffDay' => $employeeOffDay->id])) }}"
                        ...
                        <div class="form-group">
                            ...
                            <select name="employee_id" class="form-control" id="select2-1">
                                ...
                                <option selected
                                        value="{{ $employeeOffDay->employee_id }}"> {{ $employeeOffDay->employee->user->name }}
                                </option>
                                <option
                        ...
                        <div class="form-group">
                            ...
                            <select name="off_type_id" class="form-control" id="select2-2">
                                <option selected
                                        value="{{ $employeeOffDay->off_type_id }}"> {{ $employeeOffDay->off_type->name }}
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="quota" name="quota"
                                   value="{{ old('quota', $employeeOffDay->quota) }}" required>

            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="{{ url(route('web.admin.employeeOffDay.create')) }}" class="btn btn-xs btn-primary"
                               style="margin-right: 10px; margin-left: 10px; color: white; display: inline-block;">+Add</a>
                        </li>

                        @foreach($offTypes as $item)
                            <li>
                                <a href="{{ url(route('web.admin.employeeOffDay.index', ['off_type_id' => $item->id])) }}"
                                   class="btn btn-xs btn-default"
                                   style="margin-right: 10px; margin-left: 10px; display: inline-block;">{{ $item->name }}</a>
                            </li>
                        @endforeach
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade padding in active" id="Active">
                            <table class="table " id="dataTable">
                                ...
                                <tr>
                                    <th width="auto">ID</th>
                                    <th width="auto">Employee</th>
                                    <th width="auto">Type</th>
                                    <th width="auto">Quota</th>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            let datatable1 = $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ url(route('api.v1.web.admin.employeeOffDay.dataTable', ['off_type_id' => request('off_type_id')])) }}',
                    data: {

    ...
    <div class="row">
        <div class="col-xs-6 col-md-6 col-lg-6">
            <div class="panel panel-default">
                ...
                <!-- Tab panes -->
                    <form method="post" action="{{ url(route('web.admin.motivational.update', ['motivational' => $motivational->id])) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="word" class="form-control" placeholder="word" name="word"
                                   value="{{ old('word') == '' ? $motivational->word : old('word') }}" required>

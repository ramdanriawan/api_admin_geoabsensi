            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="{{ url(route('web.admin.userShift.create')) }}" class="btn btn-xs btn-primary"
                               style="margin-right: 10px; margin-left: 10px; color: white; display: inline-block;">+Add</a>
                        </li>

                        @foreach($shifts as $item)
                            <li>
                                <a href="{{ url(route('web.admin.userShift.index', ['shift_id' => $item->id])) }}" class="btn btn-xs btn-default"
    ...
    <script type="text/javascript">
        $(function () {
            ...
            let datatable1 = $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ url(route('api.v1.web.admin.userShift.dataTable', ['shift_id' => request('shift_id')])) }}',
                    data: {

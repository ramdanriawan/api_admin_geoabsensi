        ...
        <div class="col-xs-6 col-md-6 col-lg-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <!-- Tab panes -->
                    <form id="form" method="POST" action="{{ url(route('web.admin.paySlip.store')) }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input id="periodStart" type="date" name="period_start"
                                   ...
                                   value="{{ old('period_start', now()->addDays(-30)->toDateString()) }}" required>
                            @error('period_start')
                        ...
                        <div class="form-group">
                            ...
                            <input id="periodEnd" type="date" name="period_end"
                                   ...
                                   value="{{ old('period_end', now()->toDateString()) }}" required>
                            @error('period_end')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field-with-button">
                                <input type="number" step="0.01" name="deduction_bpjs_kesehatan" id="deduction_bpjs_kesehatan"
                                       class="form-control @error('deduction_bpjs_kesehatan') is-invalid @enderror"
                                       value="{{ old('deduction_bpjs_kesehatan', 0) }}" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field-with-button">
                                <input type="number" step="0.01" name="deduction_bpjs_ketenagakerjaan" id="deduction_bpjs_ketenagakerjaan"
                                       class="form-control @error('deduction_bpjs_ketenagakerjaan') is-invalid @enderror"
                                       value="{{ old('deduction_bpjs_ketenagakerjaan', 0) }}" readonly>
                                <div class="d-flex gap-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="field-with-button">
                                <input type="number" step="0.01" name="deduction_pph21"
                                       ...
                                       value="{{ old('deduction_pph21', 0) }}" readonly>
                                <div class="d-flex gap-1">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control @error('status') is-invalid @enderror">
                                ...
                                <option value="disagreed" {{ old('status') == 'disagreed' ? 'selected' : '' }}>
                                    Disagreed
                                </option>
                            </select>
                            @error('status')

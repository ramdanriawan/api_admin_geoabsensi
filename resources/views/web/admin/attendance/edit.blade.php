        ...
        <div class="col-xs-6 col-md-6 col-lg-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <!-- Tab panes -->
                    <form method="post" action="{{ url(route('web.admin.attendance.update', ['attendance' => $attendance->id])) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="name" class="form-control" placeholder="name" name="name"
                                   value="{{ old('name') == '' ? $attendance->name : old('name') }}" required>
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" placeholder="email" name="email"
                                   value="{{ old('email') == '' ? $attendance->email : old('email') }}" required>
                            @if ($errors->has('email'))
